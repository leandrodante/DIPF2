...
print(find_nearest(arrayFixed.col1,function[1-1]))
results.append(find_nearest(arrayFixed.col1,function[1-1]))
print(find_nearest(arrayFixed.col2,function[2-1]))
results.append(find_nearest(arrayFixed.col2,function[2-1]))
print(find_nearest(arrayFixed.col3,function[3-1]))
results.append(find_nearest(arrayFixed.col3,function[3-1]))
print(find_nearest(arrayFixed.col4,function[4-1]))
results.append(find_nearest(arrayFixed.col4,function[4-1]))
print(find_nearest(arrayFixed.col5,function[5-1]))
results.append(find_nearest(arrayFixed.col5,function[5-1]))
print(find_nearest(arrayFixed.col6,function[6-1]))
